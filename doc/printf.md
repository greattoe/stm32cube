...
​	**- USART2 : ** 115200 BAUD / 8Bit Data / None Parity / 1 Stop bit 
...
USART2 설정을 위해 다시 **Pinout & Configuration**탭으로 돌아가서 **Connectivity**에서 **USART2**를 선택한다. 이제 USART2에대한 Mode & Configuration 설정을 해 주어야 하지만 앞서 타겟보드 설정 과정에서 Initialize all peripherals with their default Mode? 라는 팝업에서 [ <u>Y</u>es ]를 선택했기 때문에 모든 설정이 제대로 되어 있으므로 어떤 설정들이 어떤값으로 설정되었는 지 살펴보기만 하자.

![](./img/stm32cubemx_config_usart2.png)
...
![](./img/stm32cubemx_project_manager_printf.png)
...
<img src="./img/stm32cubemx13.png" style="zoom:57%;" /> <img src="./img/stm32cubemx_code_generation_printf.png" style="zoom:57%;" />

이제 STM32CubeIDE를 실행하여 STM32CubeMX에서 생성한 코드를 import 하기위해 **<u>F</u>ile**메뉴의 **STM32 Project Create / Import**항목을 선택한다.

![](./img/stm32cubeide_stm32_project_create_import.png)

import방법 선택 창에서 **STM32CubeMX/STM32CubeIDE Project** 선택 후 [ <u>N</u>ext > ]를 클릭한다.

<img src="./img/stm32cubeide_select_create_import_mrthod.png" style="zoom:67%;" />
...
<img src="./img/import_prj_printf_from_file_system.png" style="zoom:67%;" />

**STM32CubeIDE**의 **Project Explorer**창에 좀 전에 **import**한 printf프로젝트가 나타난 것을 확인할 수 있다.

![](./img/stm32cubeide_project_explorer_printf.png)

**STM32CubeIDE**의 Project Explorer창의 printf프로젝트를 확장시켜 Core-Src-main.c를 찾아 열고 **<u>P</u>roject**메뉴의 **Build Project**항목을 선택하여 프로젝트 빌드를 테스트한다.

![](./img/stm32cubeide_project_explore_printf_main.png)

다음은 **STM32CubeMX**에서 **printf**프로젝트에 대해 자동 생성한 **main.c**의 내용이다.
