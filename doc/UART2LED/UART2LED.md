...
다음은 **STM32CubeMX**에서 **UART2LED**프로젝트에 대해 자동 생성한 **main.c**의 내용이다.
...
이제 적당한 시리얼 통신 에뮬레이터 프로그램( **[Putty](https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html)**, **[Tera Term](https://teratermproject.github.io/index-en.html)** 등 )에서 포트 COM3을 Baudrate 115200 으로 열어 `1`을 전송할 때 타겟보드의 온보드 LED가 켜지고, `0`을 전송할 때 온보드 LED가 꺼지는 지 확인한다.
