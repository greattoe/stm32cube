...
**Project Explorer**에서 **printf** > **Core** > **Src** > **main.c** 순서로 각 항목을 확장시켜 **main.c**를 연다.
...
빌드 결과는 **ST-Link**를 통해 타겟보드에 업로드 하여 동작 시켜보자. **STM32CubeIDE**의 **Run**메뉴의 **Run**항목을 클릭한다.
